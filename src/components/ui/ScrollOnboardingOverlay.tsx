  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed inset-0 z-20 pointer-events-none select-none bg-gradient-to-t from-black/80 via-black/35 to-black/50 backdrop-blur-[3px]"
        aria-hidden="true"
      >
        {/* Ambient Radial Spotlight Bloom */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[650px] max-w-full h-[380px] bg-cyan-500/[0.08] rounded-full blur-[130px] pointer-events-none" />
      </motion.div>

      {/* 2. Perfectly Centered Floating VisionOS Onboarding Pill Container across Phone, iPad, Laptop */}
      <div className="fixed bottom-8 sm:bottom-12 inset-x-0 flex items-center justify-center pointer-events-none z-30 px-4 select-none">
        <motion.div 
        ...
        >
          <div
            ...
            className="group cursor-pointer relative flex flex-col items-center gap-3 px-6 py-3.5 rounded-full bg-zinc-950/85 backdrop-blur-2xl border border-white/20 hover:border-cyan-400/60 shadow-[0_10px_35px_-5px_rgba(0,0,0,0.85),0_0_30px_-5px_rgba(56,189,248,0.3)] hover:shadow-[0_10px_40px_rgba(0,0,0,0.95),0_0_35px_rgba(56,189,248,0.5)] transition-all duration-500 overflow-hidden"
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] sm:text-xs font-mono font-medium tracking-[0.25em] text-zinc-300 group-hover:text-white uppercase transition-colors whitespace-nowrap">
