        ...
        <div className="relative aspect-[16/10] lg:aspect-[4/3] z-10 perspective-[2000px]">
          ...
          >
            ...
            <div 
              ...
              className="absolute bottom-6 right-6 text-right opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-50 bg-zinc-950/90 px-5 py-3 rounded-full backdrop-blur-xl border border-white/10 shadow-2xl"
            >
               <a href="https://red-gambit.vercel.app" target="_blank" rel="noreferrer" className="text-sm font-medium tracking-wider text-white uppercase hover:text-amber-400 transition-colors">
