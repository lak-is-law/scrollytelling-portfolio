...
export default function Contact() {
  return (
    <footer className="relative bg-[#09090b] py-32 px-6 md:px-24 border-t border-zinc-900/50">
      <div className="mx-auto max-w-7xl flex flex-col items-center text-center space-y-12">
        ...
        <div className="flex flex-col items-center gap-6 mt-8">
          <a 
            ...
            className="px-8 py-4 rounded-full bg-white text-black font-medium tracking-wide hover:scale-105 transition-transform duration-300 shadow-[0_0_30px_rgba(255,255,255,0.2)]"
          >
        ...
        <div className="pt-24 w-full flex flex-col md:flex-row justify-between items-center text-sm font-medium tracking-widest text-zinc-600 uppercase">
          ...
          <div className="flex gap-6 mt-4 md:mt-0 items-center">
            <a href="https://linkedin.com/in/lakshya-success" target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-white transition-colors flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              <span>LinkedIn</span>
            </a>
            <a href="https://github.com/lak-is-law" target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-white transition-colors flex items-center gap-2">
